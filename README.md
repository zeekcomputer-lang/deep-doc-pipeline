...
└── src/
    ...
    ├── nodes.py             LangGraph 노드 (16개 + 라우터 4개)
    ├── graph.py             그래프 조립
...
```
======================================================================
Deep Doc Pipeline v3.1 — Whitepaper Generator (EN→KR+DOCX)
...
[00:40] #12  [implications_writer] implications generated: 3 points
[00:45] #13  [translate] done: en=1600 kr=1200 ratio=0.75
[00:50] #14  [docx_builder] DOCX saved: output/20260609_164400/output.docx
...
| `DOMAIN_KNOWLEDGE` | (없음) | 시사점 도메인 배경지식 |
| `IMPLICATIONS_DIRECTIVE` | (없음) | 시사점 작성 지시 |
